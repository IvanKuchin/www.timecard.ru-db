...
DROP TABLE `helpdesk_ticket_history_helpdesk_users_view`;
DROP TABLE `helpdesk_ticket_history_last_case_state_view`;
DROP TABLE `helpdesk_ticket_history_last_helpdesk_user_update_view`;
...
DROP TABLE `timecard_approvals_view`;
...
DROP TABLE `user_bonuses_avia_view`;
DROP TABLE `user_bonuses_hotels`;
DROP TABLE `user_bonuses_hotel_view`;
DROP TABLE `user_bonuses_railroads`;
DROP TABLE `user_bonuses_railroad_view`;